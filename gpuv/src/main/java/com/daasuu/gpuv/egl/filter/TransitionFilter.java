...
public class TransitionFilter extends GlFilter {
    ...
    public TransitionFilter(int type) {
        super(DEFAULT_VERTEX_SHADER, BILATERAL_FRAGMENT_SHADER);
    ...
    public int type = 15;
    public int filterType = 12;
    public float offset = 0.5f;
    public float offset2 = 0.5f;
    public float random1 = 0.50f;
    ...
    protected void onDraw() {
        j += 30;
        mo12133N(filterType, j);
        GLES20.glUniform1fv(getHandle("wave"), f21328r.length, FloatBuffer.wrap(f21328r));
        ...
        GLES20.glUniform1f(getHandle("offset2"), offset2);
        GLES20.glUniform1f(getHandle("random1"), random1);
    }
        ...
        if (i7 == 2) {
            ...
            if (i7 == 3) {
                ...
                if (i7 == 4) {
                    ...
                    offset = (f10 / 2.0f) + 1.0f;
                    f3 = (1.0f - f10) / 4.0f;
                } else {
                    if (i7 == 8) {
                        type = 8;
                        abs = ((float) Math.abs(250 - (j % 500))) / 500.0f;
                        offset = (abs / 10.0f) + 1.0f;
                    } else if (i7 == 9) {
                        type = 8;
                        long j2 = j % 1000;
